...
begin
  ...
  FPersonList.Sort(TDelegatedComparer<TPerson>.Create(PersonCompare));
...
var
  AgeCompare : TComparison<TPerson>;
begin
  AgeCompare := function(const Left, Right: TPerson): Integer
                   begin
                     Result := Left.Age - Right.Age;
                   end;

  FPersonList.Sort(TDelegatedComparer<TPerson>.Create(AgeCompare));
